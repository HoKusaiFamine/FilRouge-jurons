  ...
  <div class="centreForm">
    <div class="formConnect">
      ...
      <form action="../Controller/executeInscription.php" method="POST">
        ...
        <p class="m-3">Login déja utilisé, Veuillez en choisir un autre.</p>
        ...
        <div class="text-center pt-1 pb-1">
          <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mt-2 mb-2" type="submit">Inscription</button>
