    ...
    <div class="formConnect">
      <form action="../Controller/executeConnect.php" method="post">
        ...
        <div class="form-outline m-2">
          <input name="loginConnect" ; type="text" id="loginConnect" class="form-control" placeholder="Login" />
        </div>
        
        <div class="form-outline m-2">
          <input name="passwordConnect" ; type="password" id="passwordConnect" class="form-control" placeholder="Mot de passe" />
        </div>

        <div class="text-center pt-1 pb-1">
          <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mt-2 mb-2" type="submit">
            Connection
          </button>
